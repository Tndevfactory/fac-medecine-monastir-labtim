        ...
        <div className="relative z-20 text-center px-4 py-4 md:py-6 lg:py-8 max-w-5xl mx-auto"> {/* Adjusted padding for smaller height */}
          ...
          {buttonContent && (
            <div className="animate-slideInFromBottom" style={{ animationDelay: '0.6s' }}>
              <Link href="/about" className="relative inline-flex items-center justify-center px-6 py-2 text-sm font-semibold text-white transition-all duration-300 ease-in-out rounded-full shadow-lg overflow-hidden group
