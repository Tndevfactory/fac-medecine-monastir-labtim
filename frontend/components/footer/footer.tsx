  ...
  return (
    <footer className="bg-white text-gray-800 border-t">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 grid grid-cols-1 md:grid-cols-5 gap-8">
        ...
        <div>
          <h4 className="font-semibold mb-2 text-gray-700">Recherche</h4> {/* Changed title */}
        ...
        <div>
          ...
          <ul className="space-y-1 text-sm text-gray-600">
            <li>Publications</li>
            <li>Thèses et HDR</li>
            <li>Masters et stages ingénieurs</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-1 text-sm text-gray-600">
            <li>Carrière</li>
            {/* Keeping commented out items as they were in the original */}
            {/* <li>Partners & Ecosystem</li>
