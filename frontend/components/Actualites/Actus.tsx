...
const Actus = () => {
  ...
  if (loading) {
    return (
      <section
        className={`py-16 bg-white overflow-hidden min-h-[30vh] flex flex-col justify-center items-center ${inter.variable}`}
      >
  ...
  return (
    <section
      className={`py-16 bg-white overflow-hidden min-h-[50vh] flex flex-col justify-center ${inter.variable}`}
    >
      {toast && (
        <Toast
