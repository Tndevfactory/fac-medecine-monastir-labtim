// app/page.tsx
// This is your root homepage component.
...
const HomePage: React.FC = async () => {
  ...
  try {
    const response = await getAllCarouselItems(); // Fetch carousel items without a token
        ...
        <div className="container mx-auto p-4 sm:p-6 lg:p-8 my-8">
          <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded-md relative text-center">
            ...
            <p className="text-sm mt-1">
              Le carrousel n'a pas pu être chargé. Veuillez vérifier la
              connexion ou le backend.
            </p>
          </div>
        </div>
      ) : (
