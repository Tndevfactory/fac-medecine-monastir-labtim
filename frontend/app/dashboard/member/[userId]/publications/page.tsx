...
const MemberPublicationsPage: React.FC<MemberPublicationsPageProps> = ({ params }) => {
  ...
  useEffect(() => {
    ...
    // FIX: Use routeUserId for comparison
  ...
  // FIX: Use routeUserId for conditional rendering
